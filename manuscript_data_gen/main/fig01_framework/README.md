...
```powershell
python manuscript_data_gen/main/fig01_framework/build.py --output build/main_sketch_revise.pdf
```
...
```powershell
python manuscript_data_gen/reproduction/code/plotting/export_framework.py --mode export --output build/framework_review/main_sketch_revise.pdf
```
