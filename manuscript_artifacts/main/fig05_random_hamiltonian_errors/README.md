...
```powershell
python manuscript_artifacts/build.py manuscript_artifacts/main/fig05_random_hamiltonian_errors --output build/general_hamiltonian_gpd_average_errors.pdf
```
