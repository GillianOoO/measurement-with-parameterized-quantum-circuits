...
def main():
    ...
    selected.update({
        ...
        "figures/published/main_sketch_revise.pdf", "paper/original/Figure1_revised_source.pptx",
    })
    ...
    external = {p: h for p, h in hashes.items() if p.split("/")[0] in {"data", "figures", "paper"}}
    ...
    manifest = {
        "schema": 2, "scope": "Current plotting code; numerical inputs and reviewed assets are supplied locally",
